...
categories: [Projects, Cloud and Virtualization, Virtual Machine (VM) Homelab]
...
- **Kali Linux:** [Kali Linux](https://www.kali.org/) is a free, open-soure, Debian-based Linux distribution made for penetration testers and ethical hackers. Essentially, it's the script kiddie's best friend.
...
_All VMs have their host computer sharing options disabled._
...
_Suricata interfaces and an example of alerts for the LAN interface. The IDS is also enabled for the Sysadmin and Malware Analysis Networks._
...
_My Splunk instance receives JSON logs from the pfSense VM on udp/5147 and stores them in the network index._
...
## Future Homelab Plans for the Windows 10, Windows Server 2022, Fedora Server 39, and Fedora KDE Plasma Desktop 39 DMs
